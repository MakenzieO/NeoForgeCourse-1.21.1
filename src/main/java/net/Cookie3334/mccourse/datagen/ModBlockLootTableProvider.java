package net.Cookie3334.mccourse.datagen;
...
public class ModBlockLootTableProvider extends BlockLootSubProvider {
    ...
    protected void generate() {
        ...
        this.add(ModBlocks.BlACK_OPAL_NETHER_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.BlACK_OPAL_NETHER_ORE.get(), ModItems.RAW_BLACK_OPAL.get(), 2, 5));
        this.add(ModBlocks.BlACK_OPAL_END_ORE.get(),
                block -> createMultipleOreDrops(ModBlocks.BlACK_OPAL_END_ORE.get(), ModItems.RAW_BLACK_OPAL.get(), 2, 5));
